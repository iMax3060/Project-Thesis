...
\newcommand{\doctitle}{Performance Evaluation of Different Open Source Implementations of Data Structures and Other Algorithms in the context of a DBMS Buffer Manager}
																					% the title of the work
\newcommand{\releasedate}{\specificdate{2019}{1}{31}}											% the release date of the thesis										
